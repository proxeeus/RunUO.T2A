...
namespace Server.Mobiles
{
    public class RealEstateBroker : BaseVendor
	{
		...
		public int ComputePriceFor( HouseDeed deed )
		{
            ...
            if ( deed is SmallBrickHouseDeed || deed is StonePlasterHouseDeed || deed is FieldStoneHouseDeed || deed is WoodHouseDeed || deed is WoodPlasterHouseDeed || deed is ThatchedRoofCottageDeed )
				price = 43800;
